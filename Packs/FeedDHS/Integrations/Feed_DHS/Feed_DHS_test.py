...
class TestHelpers:
    data_test_fix_rsa_data = [
        ('./test_data/test_fix_rsa_data.txt', 4),
        ('./test_data/test_fix_rsa_data2.txt', 2),
    ]
    ...
    data_test_indicator_to_context = []

    @pytest.mark.parametrize('', data_test_indicator_to_context)
    def test_indicator_to_context(self):
        pass
