...
def verify_copy(successful_packs, pc_successful_packs_dict):
    ...
    assert not not_uploaded and not mistakenly_uploaded, f"Mismatch in Prepare Content successful packs and" \
                                                         f" Upload successful packs\n" \
                                                         f"Packs not copied: {', '.join(not_uploaded)}\n" \
                                                         f"Packs mistakenly copied: " \
                                                         f"{', '.join(mistakenly_uploaded)}\n"
